...
import { FiEdit2, FiAward, FiBookOpen, FiStar } from "react-icons/fi";
import type { Badge, Certificat, Inscription } from "../../types";
...
export default function Profile() {
  ...
  const [, setMesCours] = useState<Inscription[]>([]);
    ...
    <div className="profile-page">
      <div className="profile-hero">
        <div className="profile-avatar-wrap">
          <img src={user?.photo_url || `https://ui-avatars.com/api/?name=${user?.prenom}+${user?.nom}&background=7B5EA7&color=fff&size=120`}
